...
<div class="displayFlex max">
        ...
        <div class="mainBody flex1">
            <!-- 顶部软件名和登陆信息等 开始-->
            <div class="title">
                    <img  class="flaotLeft companyName" src="${ctx }/static/image/title.png" alt="">
                    <!-- 用户信息 开始 -->
                    <div class="floatRight otherInfo userMan displayFlex">
                        ...
                        <c:if test="${!empty MANAGER }">
                            ...
                            <div class="">
                                <a class=""href="pwdUpdate.jsp">修改密码</a>
                            </div>
                            <div class="">
                                <a class=""href="doManagerExit.html">退出登录</a>
                            </div>
                        </c:if>
                    </div>
                    <!-- 用户信息 结束 -->
...
<script  src="${ctx }/static/js/table_criticalList.js"></script>
</html>