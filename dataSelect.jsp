        ...
        <div class="mainBody flex1">
            ...
            <div class="titleBar">
                ...
                <div class="floatLeft">
                    <%-- <span>样品类型/名称</span> --%>
                    <span>
                        <select style="padding: 0 2%;" id="scaleId" name="scaleId">
...
<script>
    $(".submit").click(function(){
        var ak =  $("#submitForm").serialize();
        // var QAQ_bb = changePageCondition ();
        // var QAQ_cc = 'typeId='+QAQ_bb.typeId+'&scaleId='+QAQ_bb.scaleId+'&beginDate='+QAQ_bb.beginDate+'&endDate='+QAQ_bb.endDate; 
        console.log(ak)
        // 请求
        $.ajax({
            type: 'POST',
