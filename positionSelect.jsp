		...
		<div class="mainBody flex1">
			...
			<form id="submitForm" action="#" method="post">
				<div class="titleBar">
					...
					<div class="floatLeft">
						<%-- <span>选择取样时间</span> --%>
						<span> <input id="beginDate" name="beginDate" type="text"
							placeholder="点击选择开始取样时间" />
						</span>
					</div>
					<div class="floatLeft">
						<%-- <span>选择取样时间</span> --%>
						<span> <input id="endDate" name="endDate" type="text"
							placeholder="点击选择结束取样时间" />
						</span>
					</div>
			...
			<div class="charts">
				...
				<div id="changePage" class="displayFlex">
					<div class="flex1"></div>
					<div class="title1" pages="1" allPage="1">
						共有 <b style="color: #A60427">0</b> 个记录 每页显示10条，本页0条 0/0页
					</div>
					...
					<div
						class="turn Right clearBoth cursoPoin thisMainBG thisMainBGColor">
						下一页</div>
...
<script src="${ctx }/static/js/table_positionSelect.js"></script>
<script>
	$(".submit").click(function() {
		// 请求
		$.ajax({
			type : 'POST',
			url : '${ctx }/positionSelect.html',
