				...
				<form id="submitForm" action="#" method="post">
					<div class="MaxAn" AnType="loginInputs">
						<div class="password">
							...
							<div class="input">
								<input class="password" type="text" id="loginId" name="loginId"
									placeholder="请输入登录账号" value="${MANAGER.loginId }"
									readonly="readonly">
							</div>
						</div>
						<div class="password">
							...
							<div class="input">
								<input class="text" type="text" id="loginNick" name="loginNick"
									placeholder="请输入用户姓名" value="${MANAGER.loginNick }"
									readonly="readonly">
							</div>
						</div>
						<div class="password">
							...
							<div class="input">
								<input class="password" type="password" id="newPwd1"
									name="newPwd1" placeholder="请输入新密码">
							</div>
						</div>
						<div class="password">
							<div class="title">重复密码</div>
							<div class="input">
								<input class="password" type="password" id="newPwd2"
									name="newPwd2" placeholder="请再次输入密码">
							</div>
						</div>
...
<script>
	...
	$(function() {
		$("#saveButton").click(function() {
			$.ajax({
				type : 'POST',
				url : '${ctx }/pwdUpdate.html',
				data : $("#submitForm").serialize(),
				processData : false,
				success : function(data) {
					if (data.success) {
						alert("已成功修改密码，下次登录请使用新密码！");
