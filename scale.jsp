	...
	<div class="displayFlex max">
		...
		<div class="mainBody flex1">
			...
			<div class="title">
				...
				<div class="floatRight otherInfo userMan displayFlex">
					...
					<c:if test="${!empty MANAGER }">
                        ${MANAGER.loginNick }
                            <div class="flex1">
							<a class="" href="pwdUpdate.jsp">你好 公子熄(管理员 )</a>
						</div>
						<div class="">
			...
			<div class="charts">
				...
				<div class="IG_NB">
					<div>
						<div rows="50" cols="50" id="scaleContent" name="scaleContent"></div>
					</div>
	...
	$(function() {
		$.ajax({
			...
			success : function(data) {
				$("#scaleContent").html(data.scale.scaleContent);
			},
			dataType : 'json'
		});
